...
void DeveloperPanel::showEvent(QShowEvent *event) {
  ...
  QList<QPair<QString, std::string>> dev_params = {
    ...
    {"Serial", params.get("HardwareSerial", false)},
...
//  layout->addWidget(new ButtonControl("WiFi 설정", "열기", "",
  ...
  // Android Setting
  layout->addWidget(new ButtonControl("Android Settings", "OPEN", "",
//  layout->addWidget(new ButtonControl("안드로이드 설정", "열기", "",
  ...
  layout->addWidget(new ButtonControl("Git Pull", "RUN", "Git Pull Process", [=]() {
...
//                                        if (ConfirmationDialog::confirm("진행하시겠습니까?")){
  ...
  layout->addWidget(new ButtonControl("Add func", "RUN", "Add func apply", [=]() {
                                        if (ConfirmationDialog::confirm("Process?")) {
...
//                                        if (ConfirmationDialog::confirm("진행하시겠습니까?")) {
  ...
  layout->addWidget(new ButtonControl("Panda Flashing", "RUN", "Panda Flashing Process", [=]() {
                                        if (ConfirmationDialog::confirm("Process?")) {
